        ...
        {targetId === 'activeProjects' ? (
          <section className={styles.PojectsWrapper}>
            ...
            <div className={styles.projectsItems}>
              ...
              <div className={styles.projectCard}>
                <img src={asteralImg} alt="chess" />
                <div className={styles.infoBlock}>
                  <h4>Asteral</h4>
                  <p>Daily Astrology app</p>
                  <p className={styles.technologyBlock}>
                    ReactNative TypeScript Tailwind AdMob REST
                  </p>
                  <div className={styles.linksBlock}>
                    <a
                      href="https://play.google.com/store/apps/details?id=com.anonymous.Taroapp"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Demo
